...
//
//
//		//game selection circle
//		textprintf(backBuffer, font, 560, 75, makecol(150, 150, 150), "game");
//		textprintf(backBuffer, font, 600, 17, makecol(150, 150, 150), "%d", kay);
//		textprintf(backBuffer, font, 600, 37, makecol(150, 150, 150), "%0.0f", camera.y);
//		textprintf(backBuffer, font, 600, 57, makecol(150, 150, 150), "%d", level);
//		buttonX = 580;
//		buttonY = 20;
//		buttonRadius = 10;
//		circle(backBuffer, buttonX, buttonY, buttonRadius, makecol(100, 100, 100));
...
//
//		//model mid
//		textprintf(backBuffer, font, 440, 75, makecol(150, 150, 150), "model mid");
//		textprintf(backBuffer, font, 500, 17, makecol(150, 150, 150), "%0.0f", modelMid.x);
//		textprintf(backBuffer, font, 500, 37, makecol(150, 150, 150), "%0.0f", modelMid.y);
//		textprintf(backBuffer, font, 500, 57, makecol(150, 150, 150), "%0.0f", modelMid.z);
//		buttonX = 480;
//		buttonY = 20;
//		buttonRadius = 10;
//		circle(backBuffer, buttonX, buttonY, buttonRadius, makecol(100, 100, 100));
